<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro43.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro43" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/asp.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">ASP.NET MVC</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Dino Esposito</a>
									</span>
								</div>
								...
								<div class="editoriales">Editorial: <span class="priceBlock">
									<a href="" itemprop="publisher">Microsoft</a>
									</span>
								</div></center>
								<br><br><br>
                                    ...
                                    <tbody><tr>
                                      <td>
                                        <div class="precioProductoN">
                                          Precio: <span class="precioN" style="color: #224757;">$122</span>
...
Plunge into the framework’s internal mechanics
Gain complete control over HTML output
Design ASP.NET MVC applications with JavaScript libraries
Use ASP.NET MVC for applications that target multiple devices</div>
							<div class="pag"> 
								 <br><br>
						</div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Bio del autor</h1><br>
								<img src="LSCA-FEnBOOKS/imagenes/dino.jpg" width="120" height="155"></center>
