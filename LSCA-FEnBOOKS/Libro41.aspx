<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro41.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro41" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/so.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Sistemas Operativos Modernos</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Andrew Tanenbaum</a>
									</span>
								</div>
								...
								<div class="editoriales">Editorial: <span class="priceBlock">
									<a href="" itemprop="publisher">Prentice Hall</a>
									</span>
								</div></center>
								<br><br><br>
							...
							<div class="pag"> 
								<br>En esta nueva edición se reordenaron los capítulos para colocar el material central al principio. También se puso mayor énfasis en el sistema operativo como el creador de las abstracciones. Los procesos, espacios de direcciones virtuales y archivos son los conceptos clave que proporcionan los sistemas operativos.- Proporcio na una introducción al lenguaje de programación C y al modelo de C en tiempo de ejecución.- Análisis de los hilos (threads), se modificó y expandió para reflejar su nueva importancia.- Sobre la administración de memoria, se reorganizó para poner énfasis en la idea de que una de las funciones clave de un sistema operativo es proporcionar la abstracción de un espacio de direcciones virtuales para cada proceso.
							...
							<div class="pag"> 
								...
								<img src="LSCA-FEnBOOKS/imagenes/tanen.jpg" width="120" height="155"></center>
...
Tanenbaum es más conocido por ser el creador de Minix, una réplica gratuita del sistema operativo UNIX con propósitos educativos, y por sus libros sobre ciencias de la computación.</div>
							<div class="hard"></div>
							<div class="hardb"></div>
						</div>	
			</div>
