<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro27.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro27" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/flores.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Las Flores del Mal</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Charles Baudelaire</a>
									</span>
								</div>
                                    ...
                                    <tbody><tr>
                                      <td>
                                        <div class="precioProductoN">
                                          Precio: <span class="precioN" style="color: #224757;">$208</span>
							...
							<div class="pag"> 
								<br>Los poemas de Las flores del mal despliegan una arquitectura verbal resplandeciente mientras nos introducen en el lado más oscuro de la naturaleza humana, esa raíz maldita que, según Baudelaire, nos alimenta a todos.

Desde su primera edición en 1857, este libro escandaloso -ahora nuevamente traducido por el poeta Pedro Provencio- ejerció una enorme influencia en la poesía posromántica y, hasta bien entrado el siglo XX, su trascendencia es equiparable a la del Cancionero de Petrarca en el Renacimiento.
</div>
							<div class="pag"> 
								 <br><br>
						</div>
							<div class="pag"> 
								...
								<img src="LSCA-FEnBOOKS/imagenes/bad.jpg" width="120" height="155"></center>
