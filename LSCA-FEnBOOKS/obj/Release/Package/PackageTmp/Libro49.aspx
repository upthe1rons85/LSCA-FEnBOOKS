<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro49.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro49" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/dios.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Dios y el Estado</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Mijhail Bakunin</a>
									</span>
								</div>
								...
								<div class="editoriales">Editorial: <span class="priceBlock">
									<a href="" itemprop="publisher">El Viejo Topo</a>
									</span>
								</div></center>
								<br><br><br>
							...
							<div class="pag"> 
								...
								<img src="LSCA-FEnBOOKS/imagenes/baku.jpg" width="120" height="155"></center>
