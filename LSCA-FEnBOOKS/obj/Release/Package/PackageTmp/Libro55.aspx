<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro55.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro55" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/dis.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Discurso del Metodo</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Rene Descartes</a>
									</span>
								</div>
                                    ...
                                    <tbody><tr>
                                      <td>
                                        <div class="precioProductoN">
                                          Precio: <span class="precioN" style="color: #224757;">$222</span>
...
Se publicó de forma anónima en Leiden (Holanda) en el año 1637. Constituía, en realidad, el prólogo a tres ensayos: Dióptrica, Meteoros y Geometría; agrupados bajo el título conjunto de Ensayos filosóficos.
							...
							<div class="pag"> 
								...
								<img src="LSCA-FEnBOOKS/imagenes/des.jpg" width="120" height="155"></center>
