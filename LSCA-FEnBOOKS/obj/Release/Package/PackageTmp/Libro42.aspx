<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro42.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro42" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/linux.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Linux & Open Source</h1><br>
							...
							<div class="pag"> 
								<br>El Gran Libro de Linux & Open Source Vol.I.

La guía esencial para dominar el software de código abierto.

Una clase magistral completa para convertirte en un experto.

Desarrollo de Apps. Trucos y consejos Pro. Backup y restauración.

Para todo usuario de Linux.

Guías de software.</div>
							<div class="pag"> 
								 <br><br>
						</div>
							<div class="pag"> 
