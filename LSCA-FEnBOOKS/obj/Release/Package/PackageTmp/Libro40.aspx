<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro40.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro40" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/alg.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Algebra Lineal</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Stanley Grossman</a>
									</span>
								</div>
								...
								<div class="editoriales">Editorial: <span class="priceBlock">
									<a href="" itemprop="publisher">McGraw Hill</a>
									</span>
								</div></center>
								<br><br><br>
                                    ...
                                    <tbody><tr>
                                      <td>
                                        <div class="precioProductoN">
                                          Precio: <span class="precioN" style="color: #224757;">$199</span>
							...
							<div class="pag"> 
								<br>Texto dirigido a estudiantes de carreras técnicas, aunque también puede ser utilizado por estudiantes de Matemáticas o Física. La estructura del libro es adecuada para este nivel; sin embargo, los lectores más avanzados pueden prescindir de algunas partes del libro, que sin duda ya conocerán de antemano. 
							...
							<div class="pag"> 
								...
								<img src="LSCA-FEnBOOKS/imagenes/stan.jpg" width="120" height="155"></center>
						Fisico Matematico de la Universidad de Cambridge y Catedratico en la Universidad de Oxford
							</div>
							<div class="hard"></div>
							<div class="hardb"></div>
						</div>	
