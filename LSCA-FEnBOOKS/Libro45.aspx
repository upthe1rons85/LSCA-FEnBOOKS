<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro45.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro45" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/html.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">HTML5 y CSS3: Revolucione el Diseño de sus sitios Web</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Christophe Aubry</a>
									</span>
								</div>
								...
								<div class="editoriales">Editorial: <span class="priceBlock">
									<a href="" itemprop="publisher">CNI Ediciones</a>
									</span>
								</div></center>
								<br><br><br>
