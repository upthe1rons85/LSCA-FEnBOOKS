<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro09.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro09" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/drac.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Dracula</h1><br>
								 <div class="espacioEntreDatos" style="padding-top:5px; ">Autor: <span class="priceBlock">
									<a href="" itemprop="seller">Bram Stoker</a>
									</span>
								</div>
                                    ...
                                    <tbody><tr>
                                      <td>
                                        <div class="precioProductoN">
                                          Precio: <span class="precioN" style="color: #224757;">$950</span>
							...
							<div class="pag"> 
								<br>Siguiendo la misma pauta que "Alicia anotada" o "Sherlock Holmes anotado", el presente libro ofrece el clásico de Bram Stoker acompañado de un amplio corpus de notas en las que se dilucidan numerosas cuestiones relacionadas con el autor, 
                                los personajes o los escenarios en los que transcurre la acción. Los textos se acompañan de un impresionante aparato gráfico que incluye mapas, grabados y fotogramas de las principales películas que han abordado uno de los textos fundacionales (si no el texto fundacional) de la literatura de vampiros.
							...
							<div class="pag"> 
								...
								<img src="LSCA-FEnBOOKS/imagenes/brms.jpg" width="120" height="155"></center>
						(Abraham Stoker, Dublín, 1847 - Londres, 1912) Novelista irlandés. Hijo de un funcionario público, hasta los siete años de edad sufrió una grave parálisis que le impedía andar. 
