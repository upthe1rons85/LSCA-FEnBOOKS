<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro35.aspx.cs" Inherits="LSCA_FEnBOOKS.Libro35" MasterPageFile="~/index.Master"%>
	...
	<div id="wrapper">
		...
		<center><div class="content">
			<div id="unityPlayer">
				<div id="flipbook">
							<div class="hard"> 								 
								<img  src="LSCA-FEnBOOKS/imagenes/rebel.jpg" width="300" height="400" itemprop="image">
							</div>
							<div class="hard"></div>
							<div class="pag"> 
								<center><br><h1 class="" style="margin-top:-7px" itemprop="name">Rebelion en la Granja</h1><br>
								...
								<div class="editoriales">Editorial: <span class="priceBlock">
									<a href="" itemprop="publisher">Random House</a>
									</span>
								</div></center>
								<br><br><br>
                                    ...
                                    <tbody><tr>
                                      <td>
                                        <div class="precioProductoN">
                                          Precio: <span class="precioN" style="color: #224757;">$99</span>
...
Además, la obra constituye un análisis de la corrupción que puede surgir tras toda adquisisión de poder, en cualquier nivel. 

							</div>
							<div class="pag"> 
								 <br><br> Así, la obra posee un doble nivel de interpretación posible, por lo que su mensaje puede trascender el caso particular del régimen soviético y ser captado incluso por niños que ni siquiera conocen la historia de la Unión Soviética. Por esta razón el libro ha sido utilizado a menudo como herramienta educativa incluso en los primeros años de la escolaridad de algunos países. Esta considerada una de las más demoledoras fábulas acerca de la condición humana.
